...
var getBuildToolsInstallerPath = require('./utils/get-build-tools-installer-path').getBuildToolsInstallerPath;
var getPythonInstallerPath = require('./utils/get-python-installer-path').getPythonInstallerPath;
...
function download(cb) {
  Promise.all([downloadTools(getBuildToolsInstallerPath()), downloadTools(getPythonInstallerPath())]).then(function () {
    return cb();
